...
## 🧩 Tech Stack
- **Frontend:** React + Next.js + TailwindCSS (File Based Routing)
...
CURRENT PHASE: DEVELOPMENT — Creating UI for flight search feature and implementing with server logic
